...
$string = array();
//content-right
$string['MY_PROFIL'] = "My profil";
$string['MY_SUGGESTIONS'] = "Suggestions";
$string['MY_ADD_EVENT'] = "Creat entry";
//content-left
$string['LIST_TITLE'] = "List";
//content-center
$string['ENTRY_DOESNT_EXIST'] = "Entry  doesn´t exist!";
$string['ENTRY_NO_ID']="No entry chosen";
//content-footer
$string['PAGE_FOOTER'] = "Copyright © Frederik Mann / License GNU GPL";

//filler
$setting = array();
$setting['SETTING_TITLE'] = "MocoDev";
$setting['SETTING_DESCRIPTION'] = "None";
$setting['SETTING_KEYWORDS'] = "None";
$setting['SETTING_ROBOTS'] = "noindex";
$setting['SETTING_STYLE'] = "./style/basis/style.css";
